...
public enum MobTypes {
    ...
    public static int getCleanSkinIconIndex(LivingEntity entity) {
        if (entity.getType().builtInRegistryHolder().is(ConventionalEntityTypeTags.BOSSES)) {
            return 4;
        }
    ...
    public static boolean isHostileForCleanSkin(LivingEntity entity) {
        return entity instanceof Enemy || entity.getType().builtInRegistryHolder().is(ConventionalEntityTypeTags.BOSSES);
    }

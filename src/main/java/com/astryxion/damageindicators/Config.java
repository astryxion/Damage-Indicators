 ...
 * <ul>
 *   <li>Style 1 - original Retro Damage Indicators look</li>
...
public class Config {
    ...
    public final ModConfigSpec.IntValue style;
    public final StyleSettings style1;
    public final StyleSettings style2;

    public Config(final ModConfigSpec.Builder builder) {
        style = builder
                .comment("Active visual style. 1 = Retro Damage Indicators (original look). 2 = Damage Indicators 1.12.2 classic look. Only the matching style section below is used in-game.")
                .translation("rdi_style")
                .defineInRange("style", 1, 1, 2);

        builder.comment("Style 1 - Retro Damage Indicators. Used only when style = 1.").push("style-1");
    ...
    public static final class StyleSettings {
        ...
        public final ModConfigSpec.BooleanValue hudPotionEffects;
        public final ModConfigSpec.ConfigValue<List<? extends String>> oldRenderEntities;

        private StyleSettings(ModConfigSpec.Builder builder, boolean retroDefaults) {

...
public final class Style1HudRenderer {
    ...
    public static void render(RenderGuiOverlayEvent.Pre event, LivingEntity entity, MobTypes mobType, boolean renderModelOnly) {
        ...
        renderEntityInGui(event.getGuiGraphics(), entityX, entityY, renderScale, ENTITY_ROTATION, entity, event.getPartialTick(), renderModelOnly);
        ...
        event.getGuiGraphics().blit(mobType.getTexture(), relativeMobTypeX, relativeMobTypeY, 50, 0, 0, 18, 18, 18, 18);
